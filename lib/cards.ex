defmodule Cards do
  ...
  @doc """
  Determines if a card is present in a deck
  ...
  @doc """
    Divides a deck into a hand and the remainder of the deck, `hand_size` argument
    indicates how many cards will be in a hand.
